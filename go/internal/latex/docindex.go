...
// then inspect it with the existing view_page tool (global 1-based
...
// 1-based page number across the whole subject (what view_page takes).
...
// table (shared with view_page's render cache).

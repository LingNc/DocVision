...
- view_pdf {path, page, left/top/right/bottom, zoom}: look at the produced PDF pages. view_image {path}: look at one image — give its full path (images/<book>/<file>) or just the file name.
